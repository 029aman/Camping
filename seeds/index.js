...
const seedDB = async () => {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        const camp = new Campground({
            ...
            images: [
                {
                    url: 'https://res.cloudinary.com/dg9tkwbcn/image/upload/v1675787761/YelpCamp/lltrmfrbwneqsjexykjq.jpg',
                    filename: 'YelpCamp/lltrmfrbwneqsjexykjq'
                },
                {
                    url: 'https://res.cloudinary.com/dg9tkwbcn/image/upload/v1675787761/YelpCamp/d2vctvuhqnkzvanncs2s.jpg',
                    filename: 'YelpCamp/d2vctvuhqnkzvanncs2s'                }
            ]
        })
        await camp.save();
    }
